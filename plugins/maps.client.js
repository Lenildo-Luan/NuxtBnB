export default function(context, inject) {
    ...
    function addScript() {
        ...
        script.src = 'https://maps.googleapis.com/maps/api/js?key=AIzaSyDRymAkEgVsj3FmwRgLQC90tQ5bVTa_umI&libraries=places&callback=initGoogleMap';
        script.async = true;
    ...
    function showMap(canvas, lat, lng, markers) {
        ...
        renderMap(canvas, lat, lng, markers);
    }

    function renderMap(canvas, lat, lng, markers) {
        const mapOptions = {
            zoom: 18,
